...
def play_again():
    ...
    if answer == 'y' or 'yes':
        ...
        pass
def get_word():
    words = ['volleyball', 'soccer', 'baseball', 'football', 'basketball', 'hockey']
...
while "guessed" == False and tries > 0:
    ...
    if len("guess") == 1:
        if guess not in alphabet:
            ...
            print('Well done, thatt letter exists in the word!')
            letters_guessed.append(guess)
        else:
    ...
    #2 - user inputs the full word
         ...
         if guess == word:
             print ('Well dont, you have guessed the word!')
             guessed = True
         else:
    ...
    #3 - user inputs letters where the total number of letters =/= total number of letters in the word.
        ...
        print('The length of the guess is not the same as the length of the word we are looking for.')
    ...
    if guessed == "False":
        ...
        if 'status' == word:
            ...
            print('You have run out of guesses and you have not guessed the word.')
